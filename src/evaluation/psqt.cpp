...
using Score = ASTROVE::eval::Score;
using EvalScore = ASTROVE::eval::EvalScore;
using ASTROVE::eval::composeEval;
...
//================= MIDDLE-GAME-TABLE ==================
// for Pawn
static const Score mgPawnPsqt[64] = {
...
// for Knight
static const Score mgKnightPsqt[64] = {
...
// for Bishop
static const Score mgBishopPsqt[64] = {
...
// for Rook
static const Score mgRookPsqt[64] = {
...
// for Queen
static const Score mgQueenPsqt[64] = {
...
// for King
static const Score mgKingPsqt[64] = {
...
// for Pawn
static const Score egPawnPsqt[64] = {
...
// for Knight
static const Score egKnightPsqt[64] = {
...
// for Bishop
static const Score egBishopPsqt[64] = {
...
// for Rook
static const Score egRookPsqt[64] = {
...
// for Queen
static const Score egQueenPsqt[64] = {
...
// for King
static const Score egKingPsqt[64] = {
...
// pointer for access during initialization
static const int16_t *mgPsqtPtrs[6] = {mgPawnPsqt, mgKnightPsqt, mgBishopPsqt,
                                       mgRookPsqt, mgQueenPsqt,  mgKingPsqt};
static const int16_t *egPsqtPtrs[6] = {egPawnPsqt, egKnightPsqt, egBishopPsqt,
                                       egRookPsqt, egQueenPsqt,  egKingPsqt};

// defines the array declared in psqt.h
EvalScore PSQT[6][2][64];

// Indexed by Piece enum
const int PiecePhaseValue[12] = {
...
void InitializePieceSquareTable() {
  // Loop through generic piece types (Pawn=0 to King=5)
  for (int pType = Pawn; pType <= King; ++pType) {
    ...
    for (int sq = 0; sq < 64; ++sq) {
      ...
      PSQT[pType][White][sq] =
          composeEval(mgPsqtPtrs[pType][FLIP(sq)], egPsqtPtrs[pType][FLIP(sq)]);

      // Black PSQT entry: read straight (arrays are already Black's
      // perspective)
      PSQT[pType][Black][sq] =
          composeEval(mgPsqtPtrs[pType][sq], egPsqtPtrs[pType][sq]);
    }
  }
}
} // namespace ASTROVE::eval